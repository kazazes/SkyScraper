<template>
  <v-flex class="player">
        ...
        <a v-on:click.prevent="playing = !playing" title="Play/Pause" href="#">
          <svg width="18px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <path v-else fill="currentColor"
                  d="M15,3h-2c-0.553,0-1,0.048-1,0.6v12.8c0,0.552,0.447,0.6,1,0.6h2c0.553,0,1-0.048,1-0.6V3.6C16,3.048,15.553,3,15,3z M7,3H5C4.447,3,4,3.048,4,3.6v12.8C4,16.952,4.447,17,5,17h2c0.553,0,1-0.048,1-0.6V3.6C8,3.048,7.553,3,7,3z"></path>
          </svg>
        </a>
      </div>
      <v-flex grow>
    ...
    <audio v-if="file" :loop="innerLoop" ref="audiofile" :src="file" preload="auto" style="display: none;"></audio>
  </v-flex>
</template>
...
<style lang="scss">
  ...
  $player-progress-color: #cacaca;
  $player-seeker-color: #ff5252;
