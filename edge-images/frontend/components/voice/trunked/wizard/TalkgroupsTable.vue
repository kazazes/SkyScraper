  ...
  <v-layout>
    <v-container fluid>
      <div class="px-4 py-0 my-0">
        <v-btn color="blue-grey darken" dark class="mb-2" @click="dialog = true">
          Add Talkgroup
        </v-btn>
        <Upload :file="file" @loadedTalkgroups="talkgroupsFileLoaded" />
      </div>
        ...
        <v-card flat>
          <v-card-text>
            <v-container grid-list-md>
              <v-layout wrap>
                <v-flex xs12 sm6 md4>
                  <v-text-field v-model="editedItem.decimal" label="Decimal" />
                </v-flex>
                <v-flex xs12 sm6 md4>
                  <v-text-field v-model="editedItem.mode" label="Mode" />
                </v-flex>
                <v-flex xs12 sm6 md4>
                  <v-text-field v-model="editedItem.alphaTag" label="Alpha Tag" />
                </v-flex>
                <v-flex xs12 sm6 md4>
                ...
                <v-flex xs12 sm6 md4>
                  <v-text-field v-model="editedItem.priority" label="Priority" />
                </v-flex>
              </v-layout>
            </v-container>
          </v-card-text>
