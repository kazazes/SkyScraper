...
# Architectures
docker manifest annotate  pckzs/bladerf pckzs/bladerf-arm:latest --arch arm64 --os linux
docker manifest annotate  pckzs/bladerf pckzs/bladerf-amd64:latest --arch amd64
